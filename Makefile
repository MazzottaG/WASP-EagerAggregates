...
#for profiling eager
cxxflags.prof = -Wall -Wextra -std=c++14 -DNDEBUG -DLP2CPP_DEBUG -O3 -g -pg
linkflags.prof = -DLP2CPP_DEBUG -g -pg -ldl 
...
parser: $(SOURCE_DIR)/lp2cpp/DLV2libs/input/aspcore2.l $(SOURCE_DIR)/lp2cpp/DLV2libs/input/aspcore2.y
	flex -o$(SOURCE_DIR)/lp2cpp/DLV2libs/input/aspcore2_lexer.hpp $(SOURCE_DIR)/lp2cpp/DLV2libs/input/aspcore2.l
	bison -y -d -o$(SOURCE_DIR)/lp2cpp/DLV2libs/input/aspcore2_parser.c $(SOURCE_DIR)/lp2cpp/DLV2libs/input/aspcore2.y
	bison -y -o$(SOURCE_DIR)/lp2cpp/DLV2libs/input/aspcore2_parser.hpp $(SOURCE_DIR)/lp2cpp/DLV2libs/input/aspcore2.y
	rm -f $(SOURCE_DIR)/lp2cpp/DLV2libs/input/aspcore2_parser.c