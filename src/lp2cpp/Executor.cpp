...
const std::string _first = "first";
const std::string _gtnumber = "gtnumber";
const std::string _reachable_color = "reachable_color";
const std::string _sup_0 = "sup_0";
const std::string _sup_1 = "sup_1";
const std::string _sup_2 = "sup_2";
const std::string _vertex_color = "vertex_color";
